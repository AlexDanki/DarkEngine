...
void MeshLoader::loadTriangles(const std::string& meshPath, btTriangleMesh* triMesh, const aiScene* loadedScene)
{
    //Assimp::Importer importer;
    ...
    if (!loadedScene || !loadedScene->HasMeshes()) {
